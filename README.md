...
### 考虑到部分用户不需要严格的过滤，新增一个规则集 [![image]("https://github.com/KPI0/uBlock-Origin_custom-rules/blob/main/images/csm.png" width="353px" />)](https://github.com/KPI0/uBlock-Origin_custom-rules/tree/main/A)
# 参考
